...
--
-- Host: 127.0.0.1
-- Generation Time: 04-Nov-2018 às 00:33
...
ALTER TABLE `paciente`
  ...
  ADD KEY `idUsuario` (`idUsuario`) USING BTREE,
  ADD KEY `fk_paciente_possui_alergia` (`idAlergia`),
  ADD KEY `fk_paciente_usa_medicamento` (`idMedicamento`),
  ADD KEY `fk_paciente_tem_doenca` (`idDoenca`);
...
--
ALTER TABLE `paciente`
  ADD CONSTRAINT `fk_paciente_possui_alergia` FOREIGN KEY (`idAlergia`) REFERENCES `alergia` (`idAlergia`),
  ADD CONSTRAINT `fk_paciente_tem_doenca` FOREIGN KEY (`idDoenca`) REFERENCES `doencas` (`idDoenca`),
  ADD CONSTRAINT `fk_paciente_usa_medicamento` FOREIGN KEY (`idMedicamento`) REFERENCES `medicamento` (`idMedicamento`);
